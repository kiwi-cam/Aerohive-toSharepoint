...
def ap_channels(access_point):
    ...
    for radio in ("wifi0", "wifi1"):
        ...
        sharepoint_update('AccessPoints', {"AP_Name": access_point.hostname, getattr(access_point, radio + "_interface")+"_Channel": getattr(access_point, primary_channel), getattr(access_point, radio + "_interface")+"_TX_Power": getattr(access_point, radio + "_tx_power_dbm")}, "<Where><Eq><FieldRef Name='AP_Name' /><Value Type='Text'>"+access_point.hostname+"</Value></Eq></Where>")
